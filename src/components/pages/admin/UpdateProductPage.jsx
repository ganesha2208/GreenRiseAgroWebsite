  ...
  const getSingleProductFunction = async () => {
    ...
    try {
      ...
      setProduct({
        ...
        imageUploadType: productData?.imageUploadType || "url",

        category: productData?.category || "",
        description: productData?.description || "",
        productBrochure: productData?.productBrochure || "",
        packagingSize: productData?.packagingSize || { value: "", unit: "kg" },
        form: productData?.form || "",
        packagingType: productData?.packagingType || "",
        dose: productData?.dose || { value: "", unit: "kg_per_acre" },
        ...
        releaseType: productData?.releaseType || "",
        moisture: productData?.moisture || { value: "", unit: "%" },
        purity: productData?.purity || { value: "", unit: "%" },
        solubility: productData?.solubility || { value: "", unit: "%" },
        shelfLife: productData?.shelfLife || { value: "", unit: "Year" },
      });
      setLoading(false);
    } catch (error) {
      console.log(error);
        ...
        <div className="login_Form bg-pink-50 px-8 py-6 border border-pink-100 rounded-xl shadow-md">
            ...
            <div className="flex items-center space-x-4 mb-2">
              <label className="flex items-center">
                <input
                  ...
                  onChange={() =>
                    setProduct({ ...product, uploadType: "file" })
                  }
                />
                <span className="text-pink-500">Upload from Device</span>
              </label>
              <label className="flex items-center">
                <input
                  ...
                  onChange={() =>
                    setProduct({ ...product, uploadType: "link" })
                  }
                />
          ...
          <div className="mb-3">
            ...
            <datalist id="chemicalFormulaOptions">
              {["C12,H11,N5", "KOH", "Manganese", "12%"].map(
                (option, index) => (
                  <option key={index} value={option} />
                )
              )}
